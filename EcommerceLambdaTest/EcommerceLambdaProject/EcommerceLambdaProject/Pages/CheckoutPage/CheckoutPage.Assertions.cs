...
public partial class CheckoutPage
{
    ...
    public void AssertProductInformationCorrect(ProductDetails expectedProduct)
    {
        ...
        var quantityMessage = $"{ErrorMessageProduct} \n Actual Result:{ProductQuantityElement(expectedProduct.Id, expectedProduct.Name).GetAttribute("value")} \n Expected Result:{expectedProduct.Quantity}";
        Assert.That(ProductQuantityElement(expectedProduct.Id, expectedProduct.Name).GetAttribute("value"), Is.EqualTo(expectedProduct.Quantity), quantityMessage);

        var unitPriceMessage = $"{ErrorMessageProduct} \n Actual Result:{ProductPriceElement("text-right", expectedProduct.UnitPrice).Text} \n Expected Result:{expectedProduct.UnitPrice}";
