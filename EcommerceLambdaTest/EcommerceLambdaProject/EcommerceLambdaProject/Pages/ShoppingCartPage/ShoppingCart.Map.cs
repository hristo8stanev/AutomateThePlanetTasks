...
public partial class ShoppingCartPages
{
 ...
 //   public IComponent ProductTotalPriceElement(string price) => Driver.FindComponent(By.XPath($"//div[@id='content']//td[@class='text-right' and contains(text(), '{price}')]//following-sibling::td"));
