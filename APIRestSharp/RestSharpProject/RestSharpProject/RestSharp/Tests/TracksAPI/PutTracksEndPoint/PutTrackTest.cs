namespace RestSharpProject.RestSharp.Tests.TracksAPI.PutTracksEndPoint
{
    public class PutTrackTest : BaseRestSharp
    {
        ...
        public async Task ContentPopulated_When_PutModifiedContent()
        {
            ...
            var putRequest = new RestRequest($"{_endpoints.TracksEndPoint}/{insertedTrack.Data.TrackId}", Method.Put);
            ...
            request = new RestRequest($"{_endpoints.TracksEndPoint}/{insertedTrack.Data.TrackId}", Method.Get);
