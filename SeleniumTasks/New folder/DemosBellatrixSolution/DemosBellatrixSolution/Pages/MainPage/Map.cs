...
public partial class BellatrixMainPage
{
    ...
    public IWebElement AddToCartButton => WaitAndFindElement(By.XPath("//a[@class='button product_type_simple add_to_cart_button ajax_add_to_cart'][0]"));
    public IWebElement MyAccountButton => WaitAndFindElement(By.XPath("//li[@class='page_item page-item-8 current_page_item focus']"));
    public IWebElement CheckoutButton => WaitAndFindElement(By.XPath("//li[@class='page_item page-item-7'][0]"));
    public IWebElement ViewCartButton => WaitAndFindElement(By.XPath("//a[@class='button wc-forward']"));
